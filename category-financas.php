...
<div class="artigos-destaque-cat">
    ...
    <div class="row">
        <div class="col-md-8 featured-big">
            <a href="/financas/os-principios-basicos-do-dinheiro"><img src="<?= get_template_directory_uri(); ?>/dist/images/featured-big-financas.jpg" class="img-fluid">
        ...
        <div class="col-md-4 featured-small">
            <a style="margin-bottom: 2rem;" href="financas/5-licoes-que-podemos-aprender-com-vida-de-warren-buffett/"><img class="img-fluid" src="<?= get_template_directory_uri(); ?>/dist/images/featured-small-financas-2.jpg"><h2>5 lições que podemos aprender com a vida de Warren Buffett</h2></a>
                    <a href="http://meumestre.eu/financas/truques-financeiros-para-economizar-para-o-seu-sonho"><img src="<?= get_template_directory_uri(); ?>/dist/images/featured-small-financas-4.jpg" class="img-fluid"><h2>Truques financeiros para economizar para o seu sonho</h2></a>
        </div>
    </div>
